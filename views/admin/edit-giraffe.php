<!-- beginning of of edit Giraffes -->

<main id="editGiraffe">
	<form class="<?php if($showform == 0){echo 'hidemyform';}else{} ?>" action="<?php echo base_url() ;?>AdminForms/updateGiraffes" method="post">
	<?php 
		if(isset($giraffeinfo)){
			foreach($giraffeinfo as $row){
	?>
	<section class="topgroup">
	<section class="topgrouptop">
		<section class="formfield">
			<input type="hidden" name="GiraffeId" value="<?php echo $row->id; ?>">
			<label class="control-label">Name</label>             
			<input type="text" class="form-control" id="Name" name="GiraffeName" value="<?php echo $row->h_name; ?>" required="">
		</section>
		<section class="formfield">
			<label class="control-label">Activism Types</label>  
			<select name="type_of_activism1" size="1" class="inputbox field_workfield" >
				<option value="<?php echo $row->type_of_activism1; ?>"><?php echo $row->type_of_activism1; ?></option>
			...
			<select name="type_of_activism2" size="1" class="inputbox field_workfield" >
				<option value="<?php echo $row->type_of_activism2; ?>"><?php echo $row->type_of_activism2; ?></option>
				<option value="animal protection" >animal protection</option>
				<option value="arts" >arts</option>
				<option value="business/workplace issues" >business/workplace issues</option>
				<option value="civil liberties" >civil liberties</option>
			...
			<select name="type_of_activism3" size="1" class="inputbox field_workfield" >
				<option value="<?php echo $row->type_of_activism3; ?>"><?php echo $row->type_of_activism3; ?></option>
				<option value="animal protection" >animal protection</option>
				<option value="arts" >arts</option>
				<option value="business/workplace issues" >business/workplace issues</option>
				<option value="civil liberties" >civil liberties</option>
		...
		<section class="formfield">     
			...
			<select name="global_area_1" size="1" class="inputbox field_workfield" >
				<option value="<?php echo $row->global_area_1 ;?>"><?php echo $row->global_area_1; ?></option>
			...
			<select name="global_area_2" size="1" class="inputbox field_workfield" >
				<option value="<?php echo $row->global_area_2; ?>" ><?php echo $row->global_area_2; ?></option>
				<option value="AFRICA" >AFRICA</option>
				<option value="ASIA" >ASIA</option>
				<option value="CENTRAL AMERICA" >CENTRAL AMERICA</option>
				<option value="EUROPE" >EUROPE</option>
		...
		<section class="formfield">
			...
			<select name="country_1" size="1" class="inputbox field_workfield" >
				<option value="<?php echo $row->country_1; ?>"><?php echo $row->country_1;?></option>
			...
			<select name="country_2" size="1" class="inputbox field_workfield" >
				<option value="<?php echo $row->country_2; ?>" ><?php echo $row->country_2; ?></option>
				<option value="-Burundi" >-Burundi</option>
				<option value="-Dem Republic of Congo" >-Dem Republic of Congo</option>
				<option value="-Ethiopia" >-Ethiopia</option>
				<option value="-Ghana" >-Ghana</option>
		...
		<section class="formfield">
			...
			<select name="state_1" size="1" class="inputbox field_workfield" >
				<option value="<?php echo $row->state_1; ?>" ><?php echo $row->state_1; ?></option>
			...
			<select name="state_2" size="1" class="inputbox field_workfield" >
				<option value="<?php echo $row->state_2; ?>" ><?php echo $row->state_2; ?></option>
				<option value="-Alabama" >-Alabama</option>
				<option value="-Alaska" >-Alaska</option>
				<option value="-Arizona" >-Arizona</option>
				<option value="-Arkansas" >-Arkansas</option>
	...
	<section class="botgroup">
		<section class="botgrouptop">
				...
				<input type="text" class="form-control" id="home_when_commended" value="<?php echo $row->home_when_commended; ?>" name="home_when_commended">
			</section>
			<section class="formfield">
				<label class="control-label">Home Now</label> 
				<input type="text" class="form-control" id="type_of_activism1" name="home_now" value="<?php echo $row->home_now; ?>">
			</section>
			<section class="formfield">
				<label class="control-label">URL</label> 
				<input type="text" class="form-control" id="type_of_activism1" name="url" value="<?php echo $row->url; ?>">
			</section>
			<section class="formfield">
				<label class="control-label">Deceased</label>
				<input type="text" class="form-control" id="type_of_activism1" name="deceased" value="<?php echo $row->deceased; ?>">
			</section>
		</section>
		...
		<section class="botgroupbot">
			<section class="formfield">
				...
				<input type="number" class="form-control" id="type_of_activism1" name="year_commended" value="<?php echo $row->year_commended; ?>">
			</section>


			<section class="formfield">
				<label class="control-label">Work location</label> 
				<input type="text" class="form-control" id="type_of_activism1" placeholder="example: Global region, country, state (if any)"name="work_location" value="<?php echo $row->work_location; ?>">
			</section>
			<section class="formfield">
				<label class="control-label">image file name</label>
				<input type="text" class="form-control" id="type_of_activism1" name="image" value="<?php echo $row->image; ?>">
			</section>
...
<aside>
	<form action="<?php echo base_url(); ?>AdminForms/editgiraffes" method="POST">
		<label>Name:</label>
			<select name="name" size="1" id="Name" >
				<option> Select </option>
					<?php 
						if(isset($gnames)){
							foreach($gnames as $row){
